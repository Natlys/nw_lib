...
namespace NW
{
	...
	public:
		a_error(cstr comment = NW_DEFAULT_STR, cv1u err_code = ERC_DEFAULT, cstr location = NW_DEFAULT_STR, cv1u line = NW_NULL);
		// --getters
		cstr get_str() const;
		...
		inline cv1u get_line() const { return m_line; }
		// --operators
...
namespace NW
{
	...
	{
	public:
		init_error(cstr location = NW_DEFAULT_STR, cv1u line = NW_NULL);
		// --getters
		// --setters
		// --operators
	private:
	...
	{
	public:
		quit_error(cstr location = NW_DEFAULT_STR, cv1u line = NW_NULL);
		// --getters
		// --setters
		// --operators
	private:
	...
	{
	public:
		run_error(cstr location = NW_DEFAULT_STR, cv1u line = NW_NULL);
		// --getters
		// --setters
		// --operators
	private:
...
namespace NW
{
	...
	{
	public:
		load_error(cstr location = NW_DEFAULT_STR, cv1u line = NW_NULL);
		// --getters
		// --setters
		// --operators
	private:
	...
	{
	public:
		save_error(cstr location = NW_DEFAULT_STR, cv1u line = NW_NULL);
		// --getters
		// --setters
		// --operators
	private:
	...
	{
	public:
		mem_error(cstr location = NW_DEFAULT_STR, cv1u line = NW_NULL);
		// --getters
		// --setters
		// --operators
	private:
